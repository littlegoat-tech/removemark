...
const NAV_LINKS = [
  { label: "Start removing", target: "#tool" },
  ...
  return (
    <nav className="fixed top-2 inset-x-0 z-50 flex justify-center px-2 md:px-4" aria-label="Main navigation">
      ...
      >
        ...
        <div className="hidden md:flex items-center gap-2" role="menubar" aria-label="Desktop navigation">
          {NAV_LINKS.map((link) => (
            <Button
              key={link.target}
              variant="ghost"
        ...
        <div className="hidden md:flex items-center gap-2">
          ...
          <Button variant="default" size="sm" className="text-xs" onClick={() => scrollTo("#tool")} role="menuitem">
            Remove Now
          </Button>
        </div>
