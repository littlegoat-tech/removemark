...
export const Skeleton: React.FC<SkeletonProps> = ({
  ...
  if (shape === "text" && lines > 1) {
    return (
      <div aria-hidden="true" role="presentation" className={cn("space-y-2", className)} {...props}>
  ...
  return (
    <div
      aria-hidden="true"
      role="presentation"
      className={cn(skeletonVariants({ variant, shape, size }), shape === "circle" ? "" : "w-full", className)}
      style={inlineStyles}
      {...props}
    />
  );
