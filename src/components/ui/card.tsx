...
export const Card = React.forwardRef<HTMLDivElement, CardProps>(({ children, className = "", ...props }, ref) => {
  return (
    <div
      ref={ref}
      className={cn("relative rounded-lg border border-border bg-card shadow-md card-highlight", className)}
      {...props}
    >
      {children}
    </div>
...
export const CardDescription: React.FC<CardDescriptionProps> = ({ children, className = "", ...props }) => {
  return (
    <p className={cn("mt-1 text-sm leading-snug text-foreground/45 text-balance", className)} {...props}>
      {children}
    </p>
  );
};
...
export const CardContent: React.FC<CardContentProps> = ({ children, className = "", ...props }) => {
  return (
    <div className={cn("text-sm p-4 text-foreground/70 leading-snug", className)} {...props}>
      {children}
    </div>
  );
};
...
export const CardActions: React.FC<CardActionsProps> = ({ children, className = "", ...props }) => {
  return (
