  ...
  return (
    <section className="relative flex h-svh w-full flex-col items-center justify-center overflow-hidden px-4 py-16 text-center md:px-16">
      <div className="relative z-10 flex max-w-2xl flex-col items-center gap-5">
        <div className="w-fit">
          <ShinyBadge>Not Found</ShinyBadge>
        </div>
        <div className="space-y-3">
          <h1 className="text-4xl font-semibold text-balance text-foreground md:text-5xl">Page not found</h1>
          <p className="text-base text-balance text-foreground/70 md:text-lg">
            We couldn't find the page you were looking for, but you can go back to the home page or go to the projects section with just one click.
          </p>
        </div>
        <div className="flex flex-wrap items-center justify-center gap-3">
          ...
          <Button asChild variant="secondary" size="md">
            <Link to="/" hash="works">
              Go to the watermark remover section
            </Link>
          </Button>
        </div>
      </div>
